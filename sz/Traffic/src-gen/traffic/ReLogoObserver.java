...
public class ReLogoObserver extends BaseObserver{
	...
	/**
	 * Makes a number of randomly oriented yieldZones and then executes a set of commands on the
	 * created yieldZones.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<traffic.relogo.YieldZone> createYieldZones(int number, Closure closure) {
		AgentSet<traffic.relogo.YieldZone> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"YieldZone");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("traffic.relogo.YieldZone")
	public AgentSet<traffic.relogo.YieldZone> createYieldZones(int number) {
		return createYieldZones(number,null);
	}

	/**
	 * Makes a number of uniformly fanned yieldZones and then executes a set of commands on the
	 * created yieldZones.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("traffic.relogo.YieldZone")
	public AgentSet<traffic.relogo.YieldZone> createOrderedYieldZones(int number, Closure closure) {
		AgentSet<traffic.relogo.YieldZone> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"YieldZone");
		for (Turtle t : createResult){
			if (t instanceof traffic.relogo.YieldZone){
				result.add((traffic.relogo.YieldZone)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("traffic.relogo.YieldZone")
	public AgentSet<traffic.relogo.YieldZone> createOrderedYieldZones(int number) {
		return createOrderedYieldZones(number,null);
	}
	...
	public AgentSet<traffic.relogo.YieldZone> yieldZones(){
		...
		for (Object e : this.getContext().getObjects(traffic.relogo.YieldZone.class)) {
	...
	public AgentSet<traffic.relogo.YieldZone> yieldZonesOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"yieldZone")){
			if (t instanceof traffic.relogo.YieldZone)
			result.add((traffic.relogo.YieldZone)t);
		}
		return result;
	...
	public AgentSet<traffic.relogo.YieldZone> yieldZonesOn(Turtle t){
		AgentSet<traffic.relogo.YieldZone> result = new AgentSet<traffic.relogo.YieldZone>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"yieldZone")){
